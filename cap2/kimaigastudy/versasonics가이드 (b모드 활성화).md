...
Receive = repmat(struct('Apod', zeros(1, Trans.numelements),'startDepth', P.startDepth, 'endDepth', amxAcqLength,'TGC, 1, 'bufnum', 1, 'framenum', 1, 'acqNum', 1, 'sampleMode', 'NS200' ), 1, 2 * Resource.RcvBuffer(1).numFrames);
